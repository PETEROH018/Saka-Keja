      ...
      <aside className="w-64 bg-white border-r border-gray-200 p-6 flex flex-col justify-between">
        <div>
          ...
          <nav className="space-y-1">
            <a href="#" className="flex items-center space-x-3 text-gray-600 hover:bg-gray-50 px-3 py-2 rounded-lg text-sm font-medium">
              <span>Dashboard</span>
            </a>
            <a href="#" className="flex items-center space-x-3 text-gray-600 hover:bg-gray-50 px-3 py-2 rounded-lg text-sm font-medium">
            ...
            <a href="#" className="flex items-center space-x-3 bg-indigo-900 text-white px-3 py-2 rounded-lg text-sm font-medium">
              <span>Profile</span>
            </a>
          </nav>
        </div>

        <button className="w-full bg-indigo-900 text-white py-2 rounded-lg text-sm font-medium hover:bg-indigo-800 transition">
          List New Property
        </button>
      </aside>
      ...
      <main className="flex-1 p-8">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-sm text-gray-500 mb-6">
            Update your professional details to build trust with potential tenants.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="flex justify-end space-x-3 pt-2">
                <button type="button" className="px-5 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50">
                  Cancel
                </button>
                <button type="button" className="px-5 py-2 bg-indigo-900 text-white rounded-lg text-sm font-medium hover:bg-indigo-800">
                  Save Changes
                </button>
              </div>
            </div>

            {/* Right Column: Profile Picture & Pro Tip */}
            <div className="space-y-6">
              ...
              <div className="bg-white p-6 rounded-xl border border-gray-200 text-center flex flex-col items-center">
                <div className="relative w-24 h-24 mb-4">
                  ...
                  />
                  <button className="absolute bottom-0 right-0 bg-indigo-900 text-white p-1.5 rounded-full border-2 border-white text-xs">
                    ✏️
                  </button>
                </div>
                <h4 className="font-semibold text-gray-900">Profile Picture</h4>
                <p className="text-xs text-gray-500 mt-1 mb-4">
                  A clear, professional photo helps build trust with students looking for housing.
                </p>
